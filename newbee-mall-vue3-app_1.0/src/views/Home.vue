  ...
  <div>
    <header class="home-header wrap" :class="{ active: state.headerScroll }">
      ...
      <div class="header-search">
        <span class="app-name">newbee商城</span>
      ...
      <!-- 这是一个根据state.isLogin变量的值决定是否显示的路由链接。 -->
    ...
    <div class="good">
      ...
      <van-skeleton title :row="3" :loading="state.loading">
        <div class="good-box">
          ...
          >
            <!--  过滤器的作用是在 item.goodsCoverImg 的前面添加一些前缀。-->
...
onMounted(async () => {
  ...
  // ==通过getHome()函数发送一个异步请求来获取首页的数据。
  // ==使用await关键字来等待数据返回，并将返回的数据解构为{ data }。
